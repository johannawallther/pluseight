...
To use these stylesheets, rename the files and pluseight with the name of your theme.
...
pluseight-alpha-default-narrow.css  
...
pluseight-alpha-default-normal.css
...
pluseight-alpha-default-wide.css
